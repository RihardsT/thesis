...
Uzstādīto operētājsistēmu ir iespējams konfigurēt iepriekš pieslēdzot HDMI kabeli pieslēdzot monitoru pie RaspberryPi, kā arī pievienojot tastatūru un tad ieslēdzot iekārtu. Tas ir variants, kā veikt konfigurāciju, ja nav iespējams RaspberryPi pievienot tīklam. Toties, tā kā uz tā tiks uzstādīts serveris, RaspberryPi tika pievienots tīklam un tad tik veikta konfigurēšana izmantojot SSH (angl. \textit{Secure Shell}).
