...
\begin{figure}[H]%!ht
	...
	\caption{Lokālas VCS}
	\label{fig:local_version_control}
\end{figure}
...
\begin{figure}[H]%!ht
	...
	\label{fig:centralized_version_control}
\end{figure}
...
\begin{figure}[H]%!ht
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=1\textwidth]{chef_overview.png}
...
% Chef pamatā galvenais ir Chef repozitorijs, kurā glabājas viss konfigurācijas kods. Izstrādātājs lejuplādē repozitoriju uz savas darbstacijas un uz tās veic arī turpmāko izstrādi. Repozitorijā atrodas recepšu grāmatas (angl. \textit{cookbooks}), kurās atrodas receptes (angl. \textit{recipes}).
% Ir galvenais Chef serveris uz kura glabājas vairākas komponentes:
% \begin{itemize}
% 	\item recepšu grāmatas (angl. \textit{cookbooks}) - kurās atrodas receptes ()
% \end{itemize}
% Chef struktūra
