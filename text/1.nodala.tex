...
Spējā programmatūra izstrāde ir krasi atšķirīgi no Ūdenskrituma modeļa
\nomenclature{Agile}{Spējā Programmatūras Izstrāde (angl. \textit{Agile software development})}
...
Testēt koda konstrukciju, tā struktūru nav tik svarīgi, kā testēt tā uzvedību. Tāpēc, TDD pēctecis ir Uzvedības virzīta izstrāde \nomenclature{BDD}{Uzvedības virzīta izstrāde (angl. \textit{Behaviour-Driven Development})}.
